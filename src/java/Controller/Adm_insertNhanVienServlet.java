 ...
 * @author ADMIN
 */
public class Adm_insertNhanVienServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ngaybatdau = request.getParameter("nvl");
        String taikhoan = request.getParameter("tk");
        String matkhau = request.getParameter("matkhau");
        

            Adm_NhanVienDAO nv = new Adm_NhanVienDAO();
            nv.insertNhanVien(hoten, ngaysinh, gioitinh, diachi, sdt, email, chucvu, ngaybatdau, taikhoan, matkhau);
