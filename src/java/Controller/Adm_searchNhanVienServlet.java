 ...
 * @author ADMIN
 */
public class Adm_searchNhanVienServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Adm_NhanVien> nhanvien = nv.searchNhanVienByName(searchName, searchName, searchName, searchName);
